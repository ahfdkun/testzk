...
public class TestZookeeper11 implements Watcher {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        ...
        ZooKeeper zk1 = new ZooKeeper("192.168.1.7:2181", 50000, new TestZookeeper11());
        ...
        ZooKeeper zk2 = new ZooKeeper("192.168.1.7:2181", 50000, new TestZookeeper11());
        zk2.addAuthInfo("digest", "foo:true".getBytes());
        // 需要权限
        zk2.delete(path2, -1);

        ZooKeeper zk3 = new ZooKeeper("192.168.1.7:2181", 50000, new TestZookeeper11());
        // 不需要权限
        zk3.delete(path, -1);
